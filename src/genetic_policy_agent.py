...
best_genes = [-0.2717, -0.3470, 0.2690, 0.5539, 0.1971, -0.9196, 0.8979]  # Win a lot with no much line sent (deprecated)
best_genes = [-0.9562, -0.5508, 0.0103, 0.2119, 0.2583, -0.5287, 0.6013]  # Win
best_genes = [-0.9948, -0.5240, 0.0803, 0.5459, 0.1121, -0.8215, 0.5364]
